...
const FAQ_ITEMS: FAQItem[] = [
  ...
  },
  {
    ...
    a: "전혀 그렇지 않습니다. 이륙에 필요한 활주로 거리를 결정하는 것은 총 무게 즉 '연료 무게'와 '화물 무게'의 합산입니다. 여객기는 기본적으로 직항개념이므로 미주, 유럽까지 직항하기 위해 비행기에 막대한 15시간용 수준의 연료를 가득 채워 이륙하므로 긴 활주로가 필수적입니다. 반면 화물 전용기는 항공화물성능을 최적화하기 위해, 연료는 50%수준만 탑재한 채 이륙하여 중간 거점 급유지 공항들(미주는 앵커리지 ANC, 유럽은 알마티 ALA / 나보이 NVI 등)을 경유하여 홉-앤-홉(Hop and Hop), 스탑바이(Stop-By)형식으로 운영하는 것이  100년 넘는 표준 화물기운항 방식입니다. 따라서 현 2,743m 활주로에서도 B777F 등 100톤급 광동체 대형 항공기 이착륙 운항가동은 당장이라도 제한없이 작동 가능합니다. \n문제해결은 활주가 길이가 아니고 화물터미널운영 능력 준비로 부터 시작되어야 합니다."
  },
  {
    q: "Q3. 청주공항 밤샘 가동에 조종사 피로 및 인근 주민 소음 피해 우려는 어떻게 무마합니까?",
    a: "청주공항이 비행금지시간(Curfew;커퓨)이 없는 24시간 운영공항이라 할지라도 초기운항부터 새벽2시 전후의 심야시간까지 운항하기에는 많은기간이 필요할것입니다. \n초기의 화물기 비행은 주간 빈 슬럿을 최대한 이용하되, 가능한한 초저녁과 이른아침시간대를 활용하는것이 소음과 슬럿 충돌을 최소화할수 있을것입니다. 화물기 운항이 증가할수록 복잡한 여객기/전투기 슬롯 혼잡을 피해 야간 및 조조(저녁 9시 전후와 새벽 6시 전후) 시간대를 골든타임으로 활용합니다. \n조종사 숙소 주변에 고성능 방음 및 차음벽 구조물을 조속히 증설 보완하고, 이륙 즉시 신속히 1,500피트(500미터) 고도까지 도달한 뒤 엔진추력을 감소하는 소음저감이륙절차(Noise Abatement) 기법을 인가 받는다면 소음 영향을 획기적으로 낮출 수 있습니다. 또한, 군 관제 부서의 야간 근무 부담은 국토교통부 관제 인력을 파견해 '민·군 합동 공동 야간 관제 체계'를 정립하면 충분히 보완 운영이 가능하리라 판단합니다."
  },
  {
  ...
  },
  {
    ...
    a: "화물기 대당 평균 연봉 1.5억원 대 조종사 14~20명 및 항공정비사, 운항관리사 및 직원 20여 명이 직접 고용 유발됩니다. 억대 전문 인력이 다수 포진되어 납입하는 갑종근로소득세만 대당 연간 수억원 안팎이 시 시세에 완벽히 환산 유입됩니다. 또한, 항공 자산의 '취적 정치장'을 인가를 통해 청주로 정식 등록하면 등록세 및 연간 부과되는 지방 재산세 부과로 항공기 수에 따라 매년 수십억 원 한도의 확고한 장기 세정 수입을 창출할 수 있어 충북도 조세 이득이 월등합니다."
  },
  {
  ...
  },
  {
    ...
    a: "ATR72-600F는 화물9톤급(최대이륙 23톤급) 카고 하이브리드 전용기로서 제트유 소모량이 대형기의 1/5수준에 불과하며, 조류 충돌 리스크 및 단거리 활주로 이착륙 안전도가 지구상에서 가장 공인받은 항공기입니다. 이우, 상하이, 후쿠오카 취항 시 기동성 있는 회전율(1일 최대 6회 편도 가능)을 제공해 정밀 이커머스 긴급 화물을 딜리버리 하는데 가동률을 극대화하여 적자 확률이 사실상 제로에 수렴하게 하는 최유리한 기종입니다."
  },
  {
    q: "Q10. 청주공항 신설 활주로 사업과 화물터미널 조기 가동, 어떻게 공존하며 시너지를 낼 수 있나요?",
    a: "충청북도에서 추진 중인 청주공항 3,200m 신설 활주로는 중장기적 항공 물류 거점으로 도약하기 위해 반드시 필요한 핵심 과제입니다. 대규모 국책 사업인 만큼 신중한 설계와 재원 마련에 최소 10~15년의 시간이 소요될 것입니다. 이와 긴밀히 연계하여 추진하는 '화물 전용 터미널 조기 가동'은 거대한 인프라가 완성되기 전, 현존하는 자원을 통해 청주공항의 항공 물류 잠재력을 조기에 실증하는 최고의 파트너 전략입니다. 즉, 현 활주로에서 화물 운항 성과를 빠르게 실현하여 매년 축적된 물류 데이터와 경제성 지표를 보여준다면, 신설 활주로의 타당성을 설득력 있게 뒷받침하여 그 건설 계획이 국가 상위 계획에 더 신속하게 반영되도록 견인하는 역할을 할 것입니다. 결과적으로, 터미널 조기 가동은 신설 활주로 추진의 마중물이 되어 함께 상생하며 시너지를 극대화하는 성공의 길이 될 것입니다."
  },
  {

...
- 고소득 조종사 및 항공 지상 전문직 연봉 가중치 산출 시, 월 기본 소득세 배정 갑종근로소득세(갑근세) 배정으로 연간 약 35억~48억 원이 시세로 지방 수입 환산.
          ...
          <div className="space-y-6 text-slate-800 text-justify">
            <div className="bg-slate-50 border-l-4 border-blue-600 p-4 mb-6">
              ...
              <p className="text-sm text-slate-900 leading-relaxed">
                “현재 청주공항은 약 1.5조 원의 막대한 국비를 투입해 3,200m 신설 활주로를 연장하고자 법안을 제정하고 있으나, <strong>현, 청주 활주로 2,743m 즉시 운항 가능</strong>합니다. <strong>화물기는 연료를 가득 탑재하지 않은 전략적 경유 비행(앵커리지, 알마티)이 정석이므로 기존 2,743m 활주로에서 80~100톤급 대형 기종(B777F)도 아무런 성능 한계 없이 즉각 상업 비행이 가능합니다.</strong> 또한 활주로 연장이나 신설 주장이 우선이 아니고, 당장의 핵심 과제인 <strong>화물터미널 장비 확보가 0순위</strong>이며, 300억 대 설비비 투입을 통한 실질적 화물터미널 리모델링 및 상시 통관 지배구조의 조속한 작동이 요구됩니다.”
              </p>
            </div>
            ...
            <p className="font-sans font-extrabold text-slate-950 text-center py-5 px-6 bg-blue-50/50 rounded-sm border-2 border-blue-300 text-base md:text-lg leading-relaxed shadow-sm">
              “청주국제공항 항공물류의 정답은 활주로의 무분별한 10년짜리 확장이 아닌, 화물이 들어서서 수속될 ‘터미널의 즉각적인 개방 가동’이며, 지자체가 보증하고 전문 운항사와 화주 포워더가 삼각 협치하는 준공공 거버넌스(SPC) 수립에 있습니다.”
            </p>
          </div>
        </div>
      </div>

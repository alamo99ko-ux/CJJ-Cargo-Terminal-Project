...
const ROADMAP_STEPS: RoadmapStep[] = [
  {
    ...
    goals: [
      ...
      "반도체(SK 하이닉스), 바이오, 긴급 전문 포워더(LX판토스 등) 앵커 화주들이 참여하는 ‘충북물류협회’ 설립",
      "항공 지입 투자자를 유치하여 초기 기체 대여 협상금(Deposit) 에스크로 구조 설계"
    ],
    infrastructure: [
      "현존 청주공항 화물터미널 공벽 사무 임대 사용사 전원 철수 및 부지 반환 요청 조치",
      "임시 통관 검사 및 조업 장비 투입 공간 리모델링 착수"
    ],
    fleet: "기종 준비 단계 (운항사 설립 및 안전운항증명[AOC] 신청 서류 마련)"
  },
  {
    ...
    goals: [
      ...
      "알테쉬(알리, 테무, 쉬인) 및 직결 물류사와의 고정 물량 보장(MRG) 계약 실행"
    ],
    infrastructure: [
      "대형 화물용 X-ray 검색기 도입 및 보세창고 정식 지정 상시 통관 완료",
      "오송 바이오 제약 수송을 위한 소규모 신선 의약품 냉장 창고 존 완비"
    ],
  ...
  },
  {
    ...
    goals: [
      ...
      "앵커리지(ANC) 경유 미국 서부, 알마티(ALA)/나보이(NVI) 경유 유럽 직물 고부가 항공 물류 통로 대형화",
      "대한항공, 아시아나 등 과점 메이저 대형사 과점 과밀 구조를 피한 틈새 독점 확보"
    ],
    infrastructure: [
      "청주공항 배후에 스마트 Cargo Complex 복합 자동화 화물 기지 신축 설계 착공",
      "냉각/방사능/특수 고위험 위험물 전용 물류 창 부지 확보 및 가동"
    ],
  ...
  },
  {
    ...
    motto: "활주로 확장 명분의 궁극적 득세 및 준공영 지자체 항공공사 정착",
    goals: [
      "연간 10만 톤 초과 실증적 통계에 기반하여 신임 활주로 연장안의 KDI 예비타당성 면제 및 득세",

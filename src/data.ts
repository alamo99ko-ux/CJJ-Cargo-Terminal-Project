...
실질적인 보틀넥은 활주로가 아닌 세관·보세창고 등의 행정 인프라 미비와 화물 전용 운하 주체의 부재입니다. 이에 따라 충청북도와 민간자본이 공동으로 컨소시엄을 구성하고, 물류협회와 준공공 형태의 화물공사를 설립하여 소형 화물기(ATR72-600F)부터 대형 화물기(B777F)까지 단계적으로 기단을 확장해 나간다면, 인천공항의 과밀 물동량을 효과적으로 분산 수용하고 연간 16만 톤 이상의 물류 처리와 충북 미래 먹거리 산업의 물류비 70% 절감을 즉시 달성할 수 있습니다.`,
